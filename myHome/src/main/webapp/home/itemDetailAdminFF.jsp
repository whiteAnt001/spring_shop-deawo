...
<table>
	<tr><th>상품번호</th><td>${ item.item_code }
		<font color="red"><form:errors path="item_code"/></font></td></tr>
	...
	<tr><th>상품설명</th><td><form:textarea path="item_spec" rows="5" cols="40" ></form:textarea>
